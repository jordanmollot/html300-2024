...
<template>
  <main class="main">
  <h1 class="display-3 text-lowercase bg-warning-subtle px-3 pb-2">Theater Rental</h1>
  <!--Used Bootstrap grid to make page components responsive to X-Large, Medium and X-Small screens/devices-->
